...
public class InputFilter extends DocumentFilter{
	...
	private Boolean isEOS; //keeps track of whether or not the current character is an EOS character.
	 ...
	 */
	private void addEllipses(String text) {
	...
	/**
	 * Pretty much the same thing as addEllipses only it's not receiving text, but checking the document pane at the indices given for
	 * the text instead of getting it as a parameter. Essentially addEllipses but backwards.
	 * @param offset
	 */
	private void removeEllipses(int offset) {
